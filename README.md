...
**Description**
Leveraging Java and MySQL, create a console based application with a multi-tier user system that can persist and retrieve data. You may choose the actual use case for your application as long as it meets all the requirements defined below. 
...
*	Stretch Goal: Employees of the bank should be able to view all of their customers information. This includes:
    * Account information
    * Account balances
    * Personal information
*	Stretch Goal Employees should be able to approve/deny open applications for accounts
*	Stretch Goal: Bank admins should be able to view and edit all accounts. This includes:
...
1. When is the project due? 
    ...
    >A: The project will be due no earlier then Friday of Week 5. The exact due date and time will be set based on cohort progress. 
